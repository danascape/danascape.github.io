...
RUN git clone https://github.com/danascape/danascape.github.io -b master /public

RUN git config --global user.email "danascape@gmail.com"
RUN git config --global user.name "Saalim Quadri"
